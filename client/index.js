...
const gridOptions = {
   ...
   // pagination: (true),
    ...
    columnDefs: [
        {field: 'CountyID', sortable: true, filter: 'agTextColumnFilter'},
        ...
        {field: 'BrdofEd',  filter: 'agSetColumnFilter'},
        {field: 'Regent',  filter: 'agNumberColumnFilter'},
        {field: 'CntyComm',  filter: 'agNumberColumnFilter'},
        {field: 'Precinct',  filter: 'agTextColumnFilter'},
        {field: 'Rwards',  filter: 'agSetColumnFilter'},
        {field: 'Swards',  filter: 'agSetColumnFilter'},
        {field: 'Schbdtrust',  filter: 'agSetColumnFilter'},
        {field: 'schbdatlrg',  filter: 'agSetColumnFilter'},
        ...
        {field: 'LikelytoVote',  filter: true},
...
console.log('entering index server.js')
